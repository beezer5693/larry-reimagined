...
const NegativeConversationCards = ({ data }: CardProps) => {
  return (
    <div className="grid w-full grid-cols-10 gap-5 text-black">
      <div className="relative col-span-10 flex flex-col items-center justify-center rounded-sm border border-black bg-sky-400 p-10 md:col-span-6 lg:col-span-5">
        <div className="absolute inset-0 -z-10 translate-x-2 translate-y-2 rounded-sm border border-black bg-white"></div>
      ...
      <div className="relative col-span-10 flex flex-col items-center justify-center rounded-sm border border-black bg-black p-10 md:col-span-4 lg:col-span-3">
        <div className="absolute inset-0 -z-10 translate-x-2 translate-y-2 rounded-sm border border-black bg-[#385DF8]"></div>
        <div className="space-y-5 text-white">
          ...
          <Button
            ...
            variant={"secondaryWithHoverAnimation"}
            className="rounded-full text-xs"
            className2="rounded-full bg-[#385DF8]"
            className3="max-w-max"
          >
            <span>Learn More</span>
            <ArrowUpRight className="ml-1" size={18} />
      ...
      <div className="relative col-span-10 flex flex-col items-center justify-center gap-5 rounded-sm border border-black bg-sky-400 p-10 md:col-span-4 lg:col-span-5">
        <div className="absolute inset-0 -z-10 translate-x-2 translate-y-2 rounded-sm border border-black bg-white"></div>
        <div className="space-y-5">
