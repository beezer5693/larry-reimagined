...
const HeroSection = () => {
  return (
    <div className="border-b border-dashed border-black pb-10 pt-7 dark:border-white">
      <section className="relative flex flex-col items-center rounded-sm border border-black bg-[#1a6c86] text-black md:flex-row md:justify-between">
        {/* Hero background */}
        <div className="absolute inset-0 -z-10 translate-x-2 translate-y-2 rounded-sm bg-black dark:bg-[#337d93]"></div>

        {/* Hero text and buttons */}
        <div className="h-full space-y-4 px-4 pt-10 md:pl-11 md:pt-0 lg:pl-20">
          <h1 className="text-center text-5xl font-medium leading-[45px] tracking-tighter sm:text-6xl md:text-left md:leading-[50px] lg:text-7xl lg:leading-[60px]">
          ...
          <div className="flex flex-col-reverse justify-center gap-3 pt-4 md:flex-row md:justify-start md:pt-5">
            ...
            <Button
              variant={"secondaryWithHoverAnimation"}
              className="w-full rounded-full hover:bg-yellow-300"
              className2="rounded-full"
              size={"lg"}
            >
              Book Larry
