...
import talk3 from "../../../../../public/assets/talks/talk3.png";
    ...
    <section className="mb-28 w-full md:mb-36 md:px-10 xl:mb-60">
      <div className="mx-auto w-full max-w-[700px] lg:max-w-screen-2xl">
        <div className="flex w-full flex-col gap-10 lg:flex-row lg:gap-20">
          ...
          <div className="h-[400px] overflow-hidden sm:rounded-2xl sm:shadow-2xl sm:shadow-neutral-500/50 md:h-[600px] lg:h-[700px] lg:flex-1">
            <Image
              src={talk3}
