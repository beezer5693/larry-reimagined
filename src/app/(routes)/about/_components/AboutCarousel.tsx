  ...
  return (
    <section className="relative w-full overflow-hidden">
      <div className="relative z-10 mx-auto w-full">
        <div className="scoller-about group mx-auto w-full pb-16 data-[animated=true]:overflow-hidden">
          <ul className="scroller__inner__about flex flex-wrap justify-center gap-4 group-data-[animated=true]:flex-nowrap">
            {aboutImageCourasel.map((img, index) => (
              <li
                key={index}
                className="relative h-[450px] w-[450px] shrink-0 overflow-hidden rounded-md shadow-2xl shadow-black/40"
              >
                <Image
                  src={img.src}
                  alt={"Larry Bryan"}
