...
const Achievement = ({ achievement }: AchievementProps) => {
  return (
    ...
    >
      <div className="card-shadow flex h-48 flex-col justify-start gap-5 rounded-xl  bg-gradient-to-b from-[#242325] to-[#171619] p-8 shadow-xl shadow-neutral-300/50 lg:h-56">
