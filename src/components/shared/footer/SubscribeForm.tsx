        ...
        <div>
          <div className="group relative">
            ...
            <Button
              ...
              className={cn(
                "absolute right-3 top-1/2 -translate-y-1/2 bg-gradient-to-br from-transparent to-transparent p-0 text-sm text-white transition duration-200 ease-in-out hover:text-white/80",
                {
